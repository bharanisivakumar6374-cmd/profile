// Simple Local Database Management System
class Database {
    constructor() {
        this.initializeDB();
    }
    ...
    initializeDB() {
        ...
        if (!localStorage.getItem('lms_assignments')) {
            ...
            localStorage.setItem('lms_assignments', JSON.stringify(defaultAssignments));
        }
